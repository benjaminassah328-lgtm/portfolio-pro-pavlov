...
export function Navbar() {
  ...
  <span className="text-2xl font-orbitron">A</span>..<span className="text-2xl text-blue-500 font-orbitron"><span></span><span className="font-orbitron text-2xl">D</span>ev</span>
</span>
        {/* Menu Desktop */}
